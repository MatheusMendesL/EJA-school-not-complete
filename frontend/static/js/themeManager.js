...
class ThemeManager {
  ...
  init() {
    ...
    console.log(
      "ThemeManager: Inicializado com sucesso. Tema atual:",
      this.theme
    );
  }
  ...
  loadTheme() {
    ...
    const savedTheme = localStorage.getItem("estudadores-theme");
  ...
  applyTheme() {
    ...
    localStorage.setItem("estudadores-theme", this.theme);
  ...
  toggleTheme() {
    console.log(
      "ThemeManager: Alternando tema de",
      this.theme,
      "para",
  ...
  addClickHandler(element) {
    console.log(
      "ThemeManager: Adicionando event listener ao elemento:",
      element
    );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log(
    "ThemeManager criado e disponível em window.themeManager:",
    window.themeManager
  );
});
